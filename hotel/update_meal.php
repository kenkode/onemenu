  ...
  return false;
    ...
    <div class="container-fluid">
            <div class="row-fluid">
                ...
                <?php
				$sel=mysqli_query($con,"select * from meal where m_id='".$_REQUEST['id']."'");
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="#">Update Meal</a> <span class="divider">.</span>	
	                                    </li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Update Meal</div>
			 ...
			 $sql = mysqli_query($con,"update meal set meal_name='".$_REQUEST['mname']."',food_type='".$_REQUEST['type']."',description='".$_REQUEST['description']."',price='".$_REQUEST['price']."',stock='".$_REQUEST['total']."' where m_id='".$_REQUEST['id']."'") or die(mysqli_error($con));
			
			 if($sql){
			  echo "<img src='images/1433075297_ok-green.png'/><span style='color:green'>Successfully update meal!";
			 }else{
			 echo "<img src='images/1433077051_cancel.png' width='24' height='24'/><span style='color:red'>An error occurred in updating meal!</span>";
			 }
			 }else{
	        $image = addslashes(file_get_contents($_FILES['image']['tmp_name']));
			 ...
			 $sql = mysqli_query($con,"update meal set meal_name='".$_REQUEST['mname']."',food_type='".$_REQUEST['type']."',description='".$_REQUEST['description']."',price='".$_REQUEST['price']."',stock='".$_REQUEST['total']."',photo='".$location."' where m_id='".$_REQUEST['id']."'") or die(mysqli_error($con));
             if($sql){
			 echo "<img src='images/1433075297_ok-green.png'/><span style='color:green'>Successfully updated meal!</span>";
			 }else{
			 ...
			 ?>
                                  ...
                                  <form class="form-signin" name="meal" method="post" onSubmit="return validateForm()" enctype="multipart/form-data">
                                   ...
                                   <tr><td width="304"> <label>Meal<span style="color:#FF0000">*</span>:</label></td><td width="629"><input type="text" class="input-block-level" placeholder="Please enter meal`s name" name="mname" value="<?php echo $arr['meal_name'];?>" style="width:500px"></td></tr>
								   <tr><td>
                                    <label>Type<span style="color:#FF0000">*</span>:</label></td><td><select name="type" style="width:500px">
									<option value="<?php echo $arr['food_type'];?>"><?php echo $arr['food_type'];?></option>
									...
									<tr><td>
									<label>Description<span style="color:#FF0000">*</span>:</label></td><td><textarea cols="30" placeholder="Food description" rows="10" name="description" style="width:500px"><?php echo $arr['description'];?></textarea></td></tr>
									<tr><td width="304"> <label>Price(sh.)<span style="color:#FF0000">*</span>:</label></td><td width="629"><input type="text" class="input-block-level" placeholder="Please enter meal`s price(sh.)" name="price" value="<?php echo $arr['price'];?>" style="width:500px"></td></tr>
									<tr><td width="304"> <label>Stock<span style="color:#FF0000">*</span>:</label></td><td width="629"><input type="text" class="input-block-level" placeholder="Please enter total meal available" value="<?php echo $arr['stock'];?>" name="total" style="width:500px"></td></tr>
									<tr><td>
									<label>Meal image:</label></td><td><input type="file" class="input-block-level" name="image" style="width:500px"><img src="<?php echo $arr['photo']; ?>" width="100" height="100" alt="No image" />
                                    </td></tr>
									<tr><td>
