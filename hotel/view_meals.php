                        ...
                        <div class="span6" style="width:970px">
                            ...
                            <div class="block" style="width:970px">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left"><a href="hotels.php">Meals</a></div>
                                ...
                                <div class="block-content collapse in" style="width:940px">
                                    <table width="10%">
                                        ...
                                        <tbody>
                                          <?php
										$selh=mysqli_query($con,"select * from meal left join hotels on meal.hotel_id=hotels.h_id where meal.m_id='".$_REQUEST['id']."'") or die(mysqli_error($con));
										
										$row=mysqli_fetch_array($selh,MYSQLI_ASSOC);
										$id = $row['m_id'];
										echo'<tr class="del'.$id.'"><td>Meal Photo:</td><td><img src='.$row['photo'].' width="50" height="50" alt="No image"/></td></tr><tr class="del'.$id.'"><td>Meal:</td><td>'.$row['meal_name'].'</td></tr><tr class="del'.$id.'"><td>Type:</td><td>'.$row['food_type'].'</td></tr><tr class="del'.$id.'"><td>Description:</td><td>'.$row['description'].'</td></tr></tr><tr><td>Stock:</td><td>'.$row['stock'].'</td></tr><tr class="del'.$id.'"><td>Price:</td><td>Ksh. '.$row['price'].'</td></tr><tr><td><a class="btn btn-success" href="meals.php">Go Back</a></td><td><a class="btn btn-danger" id='.$id.'>Delete</a></td></tr>';
