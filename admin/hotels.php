    ...
    <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                   ...
                   <div class="row-fluid" style="width:880px">
                        <div class="span6" style="width:880px">
                            <!-- block -->
                            <div class="block" style="width:880px">
                                <div class="navbar navbar-inner block-header" style="width:840px">
                                ...
                                <div class="block-content collapse in" style="width:850px">
                                    <table class="table table-striped" style="width:850px" id="example">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Logo</th>
										...
										$i++;
										$id=$row['h_id'];
										echo'<tr class="del'.$id.'"><td>'.$i.'</td><td><img src='.$row['hotel_logo'].' width="50" height="50" alt="No image" /></td><td><a href="view_hotels.php?id='.$row['h_id'].'">'.$row['hotel_name'].'</a></td><td>'.$row['hotel_email'].'</td><td>'.$row['hotel_contact'].'</td><td>'.$row['hotel_loc'].'</td><td><a href="view_hotels.php?id='.$row['h_id'].'" class="btn btn-info">View</a></td><td><a href="reporthotels.php?id='.$row['h_id'].'" target="_blank" class="btn btn-success">Report</a></td><td><a class="btn btn-danger" id='.$id.'>Delete</a></td></tr>';
										}
                                            ?>
                                        </tbody>
