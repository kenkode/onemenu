...
var n=document.forms["select"]["hid"].value;
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="#">Select Hotel</a> <span class="divider">.</span>	
	                                    </li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Select Hotel</div>
                            ...
                            <div class="block-content collapse in">
								...
								<tr><td colspan="2">
                                  ...
                                  <form target="blank" class="form-signin" action="report_meals.php" name="select" method="post" onSubmit="return validateForm()" enctype="multipart/form-data">
								  
        
									<tr><td width="304"><label>Hotel<span style="color:#FF0000">*</span>:</label></td><td><select name="hid" style="width:500px">
                                    <option value="">-------------------------select Hotel---------------------------------</option>
                                    <?php $selh=mysqli_query($con,"select * from hotels") or die(mysqli_error($con));
