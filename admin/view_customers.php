                        ...
                        <div class="span6" style="width:970px">
                            ...
                            <div class="block" style="width:970px">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left"><a href="customers.php">Customers</a></div>
                                ...
                                <div class="block-content collapse in" style="width:940px">
                                    <table width="10%">
										...
										echo'<tr><td>Customer name:</td><td>'.$row['customer_fname'].' '.$row['customer_lname'].'</td></tr><tr><td>Customer email:</td><td>'.$row['customer_email'].'</td></tr><tr><td>Customer contact:</td><td>'.$row['customer_contact'].'</td></tr><tr><td>Customer address:</td><td>'.$row['customer_address'].'</td></tr><tr><td><a href="customers.php">Go Back</a></td></tr>';
