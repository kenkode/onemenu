                        ...
                        <div class="span6" style="width:880px">
                          ...
                          <div class="block" style="width:880px">
                                <div class="navbar navbar-inner block-header" style="width:840px">
                                    <div class="muted pull-left"><a href="meals.php">Meals</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="mealreporthotelselect.php" style="background-color:orange;color:white;font-size:16px;padding:8px;border-radius:5px;text-decoration:none">Download Report</a></div>
                                    <div class="pull-right"><span class="badge badge-info">
									<?php
									$sql= mysqli_query($con,"select * from meal");
