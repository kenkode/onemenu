                        ...
                        <div class="span6" style="width:970px">
                            ...
                            <div class="block" style="width:970px">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left"><a href="hotels.php">Hotels</a></div>
                                ...
                                <div class="block-content collapse in" style="width:940px">
                                    <table width="10%">
										...
										$id = $row['h_id'];
										echo'<tr class="del'.$id.'"><td>Logo</td><td><img src='.$row['hotel_logo'].' width="50" height="50" alt="No image" /></td></tr><tr class="del'.$id.'"><td>Hotel name:</td><td>'.$row['hotel_name'].'</td></tr><tr class="del'.$id.'"><td>Hotel Email:</td><td>'.$row['hotel_email'].'</td></tr><tr class="del'.$id.'"><td>Hotel contact:</td><td>'.$row['hotel_contact'].'</td></tr><tr class="del'.$id.'"><td>Hotel address</td><td>'.$row['hotel_loc'].'</td></tr><tr><td><a class="btn btn-success" href="hotels.php">Go Back</a></td><td><a class="btn btn-danger" id='.$id.'>Delete</a></td></tr>';
