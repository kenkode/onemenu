                        ...
                        <div class="span6" style="width:970px">
                            ...
                            <div class="block" style="width:970px">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left"><a href="orders.php">Orders</a></div>
                                ...
                                <div class="block-content collapse in" style="width:940px">
                                    <table width="10%">
										...
										$id=$row['order_id'];
										echo'<tr><td>Meal:</td><td>'.$row['meal_name'].'</td></tr><tr class="del'.$id.'"><td>Type:</td><td>'.$row['food_type'].'</td></tr><tr class="del'.$id.'"><td>Hotel:</td><td>'.$row['hotel_name'].'</td></tr><tr class="del'.$id.'"><td>Customer:</td><td>'.$row['customer_fname'].' '.$row['customer_lname'].'</td></tr><tr class="del'.$id.'"><td>Price:</td><td>Ksh. '.$row['price'].'</td></tr><tr class="del'.$id.'"><td>Date ordered:</td><td>'.$row['date_ordered'].'</td></tr><tr><td><a class="btn btn-success" href="orders.php">Go Back</a></td></tr>';
