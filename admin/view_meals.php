                        ...
                        <div class="span6" style="width:970px">
                            ...
                            <div class="block" style="width:970px">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left"><a href="meals.php"><?php echo $row['meal_name'];?></a></div>
                                ...
                                <div class="block-content collapse in" style="width:940px">
                                    <table width="10%">
										...
										echo'<tr><td>Meal Photo:</td><td><img src=../hotel/'.$row['photo'].' width="50" height="50" alt="No image"/></td></tr><tr><td>Meal:</td><td>'.$row['meal_name'].'</td></tr><tr><td>Type:</td><td>'.$row['food_type'].'</td></tr><tr><td>Hotel:</td><td>'.$row['hotel_name'].'</td></tr><tr><td>Description:</td><td>'.$row['description'].'</td></tr></tr></tr><tr><td>Stock:</td><td>'.$row['stock'].'</td></tr><tr><td>Price:</td><td>Ksh. '.$row['price'].'</td></tr><tr><td><a class="btn btn-success" href="meals.php">Go Back</a></td></tr>';
